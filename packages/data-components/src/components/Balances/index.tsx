...
function _TokenBalances({
  ...
  const { balances, omissions } = useMemo<{
    ...
    balances = balances.map((balance) => {
      const uniswapToken = UniswapTokenList.tokens.find(
      ...
      return balance; // Return the balance as is if there's no matching token in UniswapTokenList
    });
