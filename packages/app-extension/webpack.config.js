...
/**
 * Prepends code to development bundle files to hide `ResizeObserver` runtime errors
 */
class HideResizeObserverLoopErrorInDevPlugin {
  apply(compiler) {
    compiler.hooks.thisCompilation.tap(
      "HideResizeObserverLoopErrorInDevPlugin",
      (compilation) => {
        compilation.hooks.processAssets.tap(
          {
            name: "HideResizeObserverLoopErrorInDevPlugin",
...
const {
  ...
  ? {
      ...
      devServer: {
        ...
        client: {
          ...
          overlay: {
            errors: true,
            warnings: false,
            // has to be inline fn because of Content Security Policy
            runtimeErrors: globalThis.__filterRuntimeErrors,
          },
        },
        hot: false,
        liveReload: false,
      ...
      plugins: [
        ...
        new HideResizeObserverLoopErrorInDevPlugin(),
      ],
    }
  : {
      dir: "build",
      ...
      patterns: [
              ...
              JSON.stringify(
                {
                  ...
                  content_security_policy: isDevelopment
                    ? {
        ...
        },
        {
          ...
          transform: function (content, path) {
            if (isDevelopment && path.endsWith(".html")) {
