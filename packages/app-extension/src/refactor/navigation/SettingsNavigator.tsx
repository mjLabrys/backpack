...
import { WalletAddAdvancedScreen } from "../screens/Unlocked/Settings/WalletAddAdvancedScreen";
...
export enum Routes {
  ...
  WalletAddAdvancedScreen = "WalletAddAdvancedScreen",
...
type SettingsScreenStackNavigatorParamList = {
  ...
  [Routes.WalletAddAdvancedScreen]: {
    blockchain: Blockchain;
  };
...
export function SettingsNavigator({
  ...
  return (
    ...
    >
      ...
      />
      <Stack.Screen
        name={Routes.WalletAddAdvancedScreen}
        component={WalletAddAdvancedScreen}
        options={({ navigation }) => {
          return {
            title: "",
            ...maybeCloseButton(false, navigation),
